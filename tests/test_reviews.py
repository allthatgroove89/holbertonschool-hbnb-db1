...
from src.persistence import data_manager
...
class TestReviewEndpoints(unittest.TestCase):
    def setUp(self):
        ...
        self.place = Place(
                name='Test Place', description='Test place', address='Test St',
                city_id='city123', latitude=40.7128,
                longitude=-74.0060, host_id='host123',
                number_of_rooms=3, number_of_bathrooms=2,
                price_per_night=100, max_guests=4, amenity_ids=[]
                )
